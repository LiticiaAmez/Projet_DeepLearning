...
# Renommer les colonnes dans df_ileDeFrance
    ...
    #df_HorsIleDeFrance['Latitude'].fillna('NAN', inplace=True)  # Utiliser NaN pour les coordonnées
    #df_HorsIleDeFrance['Longitude'].fillna('NAN', inplace=True) # Utiliser NaN pour les coordonnées
